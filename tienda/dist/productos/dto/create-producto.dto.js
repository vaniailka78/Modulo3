...
__decorate([
    ...
    __metadata("design:type", Number)
], CreateProductoDto.prototype, "enStock", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID de la categoría del producto', example: 1 }),
    (0, class_validator_1.IsNumber)({}, { message: 'El idCategoria deberia ser numerico' }),
    __metadata("design:type", Number)
