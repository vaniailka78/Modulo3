...
let RolesController = class RolesController {
    ...
    update(id, sesion, updateRoleDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Rol creado exitosamente' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard, roles_guard_1.RolesGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Listar un rol por su id' }),
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(['ADMIN']),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'No se pudo encontrar el rol' }),
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(['ADMIN']),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard, roles_guard_1.RolesGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar un rol por su id' }),
